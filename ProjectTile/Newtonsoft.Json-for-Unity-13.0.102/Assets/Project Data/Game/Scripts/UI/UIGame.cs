...
namespace Watermelon
{
    public class UIGame : UIPage
    {
        ...
        public void ShowExitPopUp()
        {
            ...
            {
                //YandexGame.FullscreenShow(null, showExitPopUp);
                quitPopUp.ExitPopUpConfirmExitButton();
                quitPopUp.ExitPopCloseButton();
            }
            else
            {
                showExitPopUp();
        ...
        public void OnLevelInputUpdatedDev(string newLevel)
        {
            ...
            {
                LevelSave levelSave = SaverManagerMy.GetSaveObject<LevelSave>("level");
