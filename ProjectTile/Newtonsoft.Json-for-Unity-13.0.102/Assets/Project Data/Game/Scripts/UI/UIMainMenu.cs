    ...
    public class UIMainMenu : UIPage
    {
        ...
        public override void PlayShowAnimation()
        {
            ...
            if (LocalizationManager.CurrentLanguage == "English")
                ...
                playButtonText.text = "спнбемэ " + (LevelController.MaxReachedLevelIndex + 1);
        ...
        private void PlayButton()
        {
            ...
            {
                YandexGame.FullscreenShow(null, playButtonCallback);
            }
            else
            {
                playButtonCallback();
        ...
        [SerializeField] private PurchaseYG[] purchasesYG;
        ...
        private void IAPStoreButton()
        {
            ...
            foreach (PurchaseYG purchaseYG in purchasesYG)
                purchaseYG.UpdateEntries();
            /*Debug.Log("IAP DEBUG: " + purchasesYG.Length);
            for (int i = 0; i < purchasesYG.Length; i++)
            {
                if (purchasesYG[i] != null)
                    Debug.Log("IAP DEBUG: " + i + "!= null");
                else
                    Debug.Log("IAP DEBUG: " + i + "== null");
            }*/
