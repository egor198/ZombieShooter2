...
namespace Watermelon
{
    public class PUUIPurchasePanel : MonoBehaviour, IPopupWindow
    {
        ...
        [SerializeField] Button adsRewardButton;
        ...
        private void Awake()
        {
            ...
            adsRewardButton.onClick.AddListener(Reward);
        }
        ...
        void Rewarded(int id)
        {
            if (id == 2)
            {
                CurrenciesController.Set(CurrencyType.Coins, CurrenciesController.Get(CurrencyType.Coins) + 150);
                bool purchaseSuccessful = PUController.PurchasePowerUp(settings.Type);
