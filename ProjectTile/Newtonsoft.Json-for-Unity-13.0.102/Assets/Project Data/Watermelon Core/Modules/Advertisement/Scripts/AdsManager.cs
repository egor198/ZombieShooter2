...
namespace Watermelon
{
    ...
    public static class AdsManager
    {
        ...
        {
            return true;//IsInterstitialLoaded(settings.InterstitialType);
        }
        ...
        public static bool IsForcedAdEnabled(bool useCachedValue = true)
        {
            ...
            return !SavesYG.GetString(NO_ADS_PREF_NAME, "").Equals(NO_ADS_ACTIVE_HASH);
        }
        ...
        public static void DisableForcedAd()
        {
            ...
            SavesYG.SetString(NO_ADS_PREF_NAME, NO_ADS_ACTIVE_HASH);
