    ...
    public partial class PrefsSettings : ScriptableObject
    {
        ...
        public void Load()
        {
            ...
            foreach (Key key in System.Enum.GetValues(typeof(Key)))
            {
                ...
                if (HasKey(key))
                {
                    ...
                    {
                        case FieldType.Bool:
                            prefsSettings.settings.boolSettings[settingInfo.index].value = (bool)System.Convert.ChangeType(SavesYG.GetString(PREFS_PREFIX + key, null), typeof(bool));
                            break;
                        case FieldType.Float:
                            prefsSettings.settings.floatSettings[settingInfo.index].value = SavesYG.GetFloat(PREFS_PREFIX + key);
                            break;
                        case FieldType.Int:
                            prefsSettings.settings.intSettings[settingInfo.index].value = SavesYG.GetInt(PREFS_PREFIX + key);
                            break;
                        case FieldType.Long:
                            prefsSettings.settings.longSettings[settingInfo.index].value = (long)System.Convert.ChangeType(SavesYG.GetString(PREFS_PREFIX + key, null), typeof(long));
                            break;
                        case FieldType.String:
                            prefsSettings.settings.stringSettings[settingInfo.index].value = SavesYG.GetString(PREFS_PREFIX + key);
                            break;
                        case FieldType.DateTime:
                            prefsSettings.settings.dateTimeSettings[settingInfo.index].value = SavesYG.GetString(PREFS_PREFIX + key);
                            break;
                        case FieldType.Double:
                            prefsSettings.settings.doubleSettings[settingInfo.index].value = (double)System.Convert.ChangeType(SavesYG.GetString(PREFS_PREFIX + key, null), typeof(double));
                            break;
                    }
                }
                else
        ...
        public static void SetBool(Key key, bool value)
        {
            ...
            if (settingInfo.fieldType == FieldType.Bool)
            {
                ...
                SavesYG.SetString(PREFS_PREFIX + key.ToString(), value.ToString());
            }
            else
            {
        ...
        public static void SetFloat(Key key, float value)
        {
            ...
            if (settingInfo.fieldType == FieldType.Float)
            {
                ...
                SavesYG.SetFloat(PREFS_PREFIX + key.ToString(), value);
            }
            else
            {
                throw new System.Exception(INCORRECT_TYPE_ERROR_MESSAGE);
        ...
        public static void SetInt(Key key, int value)
        {
            ...
            if (settingInfo.fieldType == FieldType.Int)
            {
                ...
                SavesYG.SetInt(PREFS_PREFIX + key.ToString(), value);
            }
            else
            {
                throw new System.Exception(INCORRECT_TYPE_ERROR_MESSAGE);
        ...
        public static void SetString(Key key, string value)
        {
            ...
            if (settingInfo.fieldType == FieldType.String)
            {
                ...
                SavesYG.SetString(PREFS_PREFIX + key.ToString(), value);
            }
            else
            {
                throw new System.Exception(INCORRECT_TYPE_ERROR_MESSAGE);
        ...
        {
            return SavesYG.HasKey(PREFS_PREFIX + key);
        }

        public static void RemoveKey(Key key)
        {
            SavesYG.DeleteKey(PREFS_PREFIX + key);
        }
